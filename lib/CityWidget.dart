...
import 'package:flutter_app02/CityData.dart';
import 'package:flutter_app02/WeatherWidget.dart';
...
class CityState extends State<CityWidget> {
  ...
  Future<List<CityData>> _fetchCityList() async {
    final response = await http.get(
        'https://search.heweather.net/top?group=cn&key=ebb698e9bb6844199e6fd23cbb9a77c5');
